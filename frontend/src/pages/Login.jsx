      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 text-white bg-gradient-to-br from-slate-900 via-fuchsia-800 to-orange-600 overflow-hidden">
        ...
        <div className="relative space-y-6">
          ...
          <div className="space-y-3 pt-4">
            ...
            <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center"><Trophy className="w-5 h-5" /></div><div><div className="font-semibold">Real prizes</div><div className="text-xs text-white/70">Verified winners, delivered per T&amp;Cs</div></div></div>
